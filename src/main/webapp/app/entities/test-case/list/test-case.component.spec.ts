...
describe('TestCase Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'test-case', component: TestCaseComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.testCases?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to testCaseService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getTestCaseIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getTestCaseIdentifier).toHaveBeenCalledWith(entity);
